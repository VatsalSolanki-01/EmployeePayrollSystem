...
public class Main1 {
    ...
    public static void sortFullTimeEmployees(){ // for sorting Fulltime employees by their ids 
        Collections.sort(fullTimeEmployeeList,(o1,o2) -> o1.getId().compareTo(o2.getId()));
    }  

    public static void sortPartTimeEmployees(){ // for sorting Parttime employees by their ids
        Collections.sort(PartTimeEmployeeList,(o1,o2) -> o1.getId().compareTo(o2.getId()));
    }  

    public static boolean isIdSameFullTimeEmployee(int id){ // To check wheather a employee with same id exists or not in Fulltime employees
    ...
    public static boolean isIdSamePartTimeEmployee(int id){ //To check wheather a employee with same id exists or not in Parttime employees
        boolean result=false;
    ...
    public static void menu(){ // To provide all the functionality options to the user 
        loop: while(true){
                System.out.println("+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++");
    ...
    public static void create(){ // To create a new reocrd of Fulltime or a Parttime employee
        ...
        switch (input) {
            ...
            int id = sc.nextInt();
            while(isIdSameFullTimeEmployee(id)){
            ...
            sortFullTimeEmployees();
            break;
            
            case 2:
            System.out.print("enter id of Employee :- ");
            int id1 = sc.nextInt();
            while(isIdSamePartTimeEmployee(id1)){
                System.out.print("id already exists enter new id");
                id1=sc.nextInt();
            }
            sc.nextLine();
    ...
    public static void read(){ // To read all the records of Fulltime or parttime employees
    ...
    public static void update(){ // To update employee name or salary of fulltime or parttime employee
    ...
    public static void delete(){ // To delte the record of fulltime or parttime employee
    ...
    public static void monthlyExpense(){ // To get the expenses occured on the fulltime or parttime employee or both together
